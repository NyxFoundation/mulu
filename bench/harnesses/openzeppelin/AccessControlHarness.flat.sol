...
// oz/utils/introspection/ERC165.sol
...
// src/AccessControlHarness.sol

contract AccessControlHarness is AccessControl {
    function restricted(bytes32 role) external onlyRole(role) {}
}
