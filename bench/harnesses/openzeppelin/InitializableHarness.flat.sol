...
// oz/proxy/utils/Initializable.sol
...
contract InitializableHarness is Initializable {
    ...
    function version() public view returns (uint64) { return _getInitializedVersion(); }
    function initializing() public view returns (bool) { return _isInitializing(); }
}
